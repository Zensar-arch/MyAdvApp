...
public class WelcomeServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<p>Your session time period is "+session.getMaxInactiveInterval() +"seconds</p>");
		out.println("<p><a href='searchInfo'>Search</a></p>");
		out.println("<p>For Shopping in Amazon Click here:<a href='searchServlet'>Search</a></p>");
